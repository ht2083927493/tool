...
\033[1;97m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
\033[1;39m┌──────────────────────── HIẾU TOOL  ──────────────────────────┐
\033[1;32m║   \033[1;39mPYTHON VERSION\033[1;32m     :  6.0                                  \033[1;32m║
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("[ TLC ] Send Sms - Call | Api - Free | Delay : 5 | Status : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f" TLC_ GAMER | MADE IN VIET NAM 🇻🇳 \r",end="")
