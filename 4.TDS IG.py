...
Write.Print('╚═╝░░╚═╝╚═╝╚══════╝░╚═════╝░ ░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝\n',Colors.cyan_to_green,interval=0.0001)
Write.Print(' \n',Colors.green_to_red,interval=0.0001,end='\r')
Write.Print(' ➩ ADMIN © HIẾU_TOOL  \n',Colors.red,interval=0.0001)
Write.Print(' ➩ NHÓM ZALO: https://zalo.me/g/wfakde942 \n',Colors.yellow,interval=0.0001)
Write.Print(' ➩ YOUTUBE: https://www.youtube.com/@hieutool248 \n',Colors.white,interval=0.0001)
Write.Print(' \n',Colors.green_to_red,interval=0.0001,end='\r')
Write.Print('========================================================= \n',Colors.cyan_to_blue,interval=0.0001)
def clear_terminal():
	os.system('clear')
                        ...
                        if(len(job)>=1):
                            ...
                            for job in job:
                                ...
                                for i in range(int(delayfl),-1,-1):
                                    print(f'{Red}[{Green}H{Yellow}I{Blue}Ê{Purple}U-{Green}T{Yellow}O{Blue}O{Yellow}L{Red}]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}|{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Green}H{Yellow}I{Blue}Ê{Purple}U-{Green}T{Yellow}O{Blue}O{Yellow}L{Red}]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}|{Red}] ',end='\r')
                                    sleep(0.2)
                                    print(f'{Red}[{Green}H{Yellow}I{Blue}Ê{Purple}U-{Green}T{Yellow}O{Blue}O{Yellow}L{Red}]{Red}[{White}{str(i)}{Red}]  {Green}SLEEP {Red}[{White}|{Red}] ',end='\r')
